 ...
 */
public class NewThisWeekRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  public  byte[] bitmapdata;
    ...
    Activity context;
    public NewThisWeekRecyclerViewAdapter(List<Products> contents,Activity context) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        switch (getItemViewType(position)) {
            case TYPE_HEADER:
                ImageView image = (ImageView)  holder.itemView.findViewById(R.id.imageView23);
                TextView title = (TextView)  holder.itemView.findViewById(R.id.title1);
                TextView oldprice = (TextView)  holder.itemView.findViewById(R.id.old_price_value1);

                ButtonFlat details = (ButtonFlat)holder.itemView.findViewById(R.id.buttonflat22);
                ...
                image.setImageBitmap(bitmap);
                    ...
                    title.setText(contents.get(position).getProduct_name());

                    oldprice.setText(contents.get(position).getProduct_price() + " DT");
                ...
                ButtonFlat add = (ButtonFlat) holder.itemView.findViewById(R.id.buttonflat2);
...
if(!productBudgetList.isEmpty()){
    ...
    budgetBDD.close();
            ...
            case TYPE_CELL:
                ...
                ButtonFlat details2 = (ButtonFlat)holder.itemView.findViewById(R.id.buttonflat33);
                ...
                ButtonFlat add2 = (ButtonFlat) holder.itemView.findViewById(R.id.buttonflat3);
                ...
                add2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (productsList.isEmpty()) {
                            ...
                            if (exist == false) {
                                Shopping_list_name = productsList.get(0).getShopping_list_name();
                                if (Container.budget_enabled == true) {
                                    productBudgetList = new ArrayList<Budget>();
                                    budgetBDD = new BudgetBDD(holder.itemView.getContext());
                                    budgetBDD.open();
                                    productBudgetList = budgetBDD.selectAll();
