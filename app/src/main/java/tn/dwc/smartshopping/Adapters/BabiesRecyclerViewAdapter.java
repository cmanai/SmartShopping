 ...
 */
public class BabiesRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  implements SnackBar.OnMessageClickListener   {
    ...
    Activity context;
    public BabiesRecyclerViewAdapter(List<Products> contents,Activity context) {
