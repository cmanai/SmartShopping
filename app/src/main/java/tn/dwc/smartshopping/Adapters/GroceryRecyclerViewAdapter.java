 ...
 */
public class GroceryRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SnackBar.OnMessageClickListener   {
    ...
    Activity context;
    public GroceryRecyclerViewAdapter(List<Products> contents,Activity context) {
