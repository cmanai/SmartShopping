 ...
 */
public class DeliRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SnackBar.OnMessageClickListener   {
    ...
    Activity context;
    public DeliRecyclerViewAdapter(List<Products> contents,Activity context) {
