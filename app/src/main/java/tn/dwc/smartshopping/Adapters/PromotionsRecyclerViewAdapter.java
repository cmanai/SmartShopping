...
import tn.dwc.smartshopping.Activities.DetailsPromoActivity;
 ...
 */
public class PromotionsRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SnackBar.OnMessageClickListener  {

    List<Promotions> contents;
    ...
    Activity context;
    public PromotionsRecyclerViewAdapter(List<Promotions> contents,Activity context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = null;
                ...
                view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.promotion_list_item_card_big, parent, false);
        par=parent.getContext();
        par2=parent;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_HEADER:
                ImageView image = (ImageView)  holder.itemView.findViewById(R.id.imageView2);
                TextView title = (TextView)  holder.itemView.findViewById(R.id.title);
                TextView oldprice = (TextView)  holder.itemView.findViewById(R.id.old_price_value);
                TextView newprice = (TextView)  holder.itemView.findViewById(R.id.new_price_value);
                TextView reduction = (TextView)  holder.itemView.findViewById(R.id.reduction);

                ButtonFlat details = (ButtonFlat)holder.itemView.findViewById(R.id.buttonflat11);
                ButtonFlat add =(ButtonFlat)holder.itemView.findViewById(R.id.buttonflat1);
                bitmapdata = contents.get(position).getPromotion_image();
                ...
                title.setText(contents.get(position).getPromotion_name());

                    oldprice.setText(contents.get(position).getPromotion_old_price() + " DT");

                    newprice.setText(contents.get(position).getPromotion_new_price() + " DT");

                    reduction.setText("- " + contents.get(position).getPromotion_pourcentage() + "%");
                ...
                details.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent i;
                        i = new Intent(holder.itemView.getContext(), DetailsPromoActivity.class);
                        i.putExtra("product_id", contents.get(position).getPromotion_id());
                        i.putExtra("product_sheve_id", contents.get(position).getPromotion_sheve_id());
                        i.putExtra("product_name", contents.get(position).getPromotion_name());
                        i.putExtra("product_old_price", contents.get(position).getPromotion_old_price());
                        i.putExtra("product_new_price", contents.get(position).getPromotion_new_price());
                        i.putExtra("product_pourcentage", contents.get(position).getPromotion_pourcentage());
                        i.putExtra("product_category", contents.get(position).getPromotion_category());
                        if (contents.get(position).getPromotion_sub_category().equals("none")) {
                            i.putExtra("product_category", contents.get(position).getPromotion_category());
                        } else {

                            i.putExtra("product_category", contents.get(position).getPromotion_category() + " - " + contents.get(position).getPromotion_sub_category());
                        }
                        i.putExtra("product_description", contents.get(position).getPromotion_Product_desc());
                        i.putExtra("product_picture", contents.get(position).getPromotion_image());
                ...
                add.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        id=  contents.get(position).getPromotion_id();
                        id_sheve=contents.get(position).getPromotion_sheve_id();
                        name=contents.get(position).getPromotion_name();
                        price=contents.get(position).getPromotion_new_price();
                        new_price=contents.get(position).getPromotion_new_price();
                        old_price=contents.get(position).getPromotion_old_price();
                        discount=contents.get(position).getPromotion_pourcentage();
                        bitmapdata = contents.get(position).getPromotion_image();
Log.e("Product selected",name);
                        if (contents.get(position).getPromotion_sub_category().equals("none")) {
                            category=contents.get(position).getPromotion_category();
                        } else {

                            category=contents.get(position).getPromotion_category() + " - " + contents.get(position).getPromotion_sub_category();
                        }
