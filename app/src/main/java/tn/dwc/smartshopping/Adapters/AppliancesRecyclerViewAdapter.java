 ...
 */
public class AppliancesRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  implements SnackBar.OnMessageClickListener  {
    ...
    Activity context;
    public AppliancesRecyclerViewAdapter(List<Products> contents,Activity context) {
    ...
    public AppliancesRecyclerViewAdapter(List<Products> contents) {
        this.contents = contents;
    }
