 ...
 */
public class CreameryRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SnackBar.OnMessageClickListener  {
    ...
    Activity context;
    public CreameryRecyclerViewAdapter(List<Products> contents,Activity context) {
