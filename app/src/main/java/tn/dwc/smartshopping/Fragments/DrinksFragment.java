...
import tn.dwc.smartshopping.Adapters.DrinksRecyclerViewAdapter;
...
List<Promotions> promotionsList;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new DrinksRecyclerViewAdapter(mContentItems,getActivity()));
...
productBDD.close();
        ...
        for(Products p : productsList){
            ...
            if(p.getProduct_category().toString().equals("Drinks")){
