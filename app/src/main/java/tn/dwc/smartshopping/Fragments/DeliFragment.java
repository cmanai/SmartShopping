...
import tn.dwc.smartshopping.Adapters.DeliRecyclerViewAdapter;
 ...
 */
public class DeliFragment extends Fragment {
...
List<Promotions> promotionsList;
    ...
    public static DeliFragment newInstance() {
        return new DeliFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new DeliRecyclerViewAdapter(mContentItems,getActivity()));
...
productBDD.close();
        ...
        for(Products p : productsList){
            ...
            if(p.getProduct_category().toString().equals("Deli")){
