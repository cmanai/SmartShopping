...
import tn.dwc.smartshopping.Adapters.GroceryRecyclerViewAdapter;
...
List<Promotions> promotionsList;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new GroceryRecyclerViewAdapter(mContentItems,getActivity()));
...
productBDD.close();
        ...
        for(Products p : productsList){
            ...
            if(p.getProduct_category().toString().equals("Grocery")){
