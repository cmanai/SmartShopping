...
import tn.dwc.smartshopping.Adapters.MarketRecyclerViewAdapter;
...
List<Promotions> promotionsList;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new MarketRecyclerViewAdapter(mContentItems,getActivity()));
...
productBDD.close();
        ...
        for(Products p : productsList){
            ...
            if(p.getProduct_category().toString().equals("Market")){
