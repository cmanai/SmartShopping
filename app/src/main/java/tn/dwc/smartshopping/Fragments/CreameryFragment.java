...
import tn.dwc.smartshopping.Adapters.CreameryRecyclerViewAdapter;
 ...
 */
public class CreameryFragment extends Fragment {
...
List<Promotions> promotionsList;
    ...
    public static CreameryFragment newInstance() {
        return new CreameryFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new RecyclerViewMaterialAdapter(new CreameryRecyclerViewAdapter(mContentItems,getActivity()));
...
productBDD.close();
        ...
        for(Products p : productsList){
            ...
            if(p.getProduct_category().toString().equals("Creamery")){
