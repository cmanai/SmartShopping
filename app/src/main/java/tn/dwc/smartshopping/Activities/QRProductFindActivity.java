...
public class QRProductFindActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_qr_product);
...
maps_products= new ArrayList<>();
        ...
        shelve_id_p = getIntent().getStringExtra("shelve_id");

        product_id_p = getIntent().getStringExtra("product_id");
        ...
        for (Maps_Product m : maps_products){
            ...
            if(m.getH_B_p().equals(hb)
                    &&m.getProduct_Id_p().equals(product_id_p)
                    &&m.getShelve_Id_p().equals(shelve_id_p)){

                bitmap2 = BitmapFactory.decodeByteArray(m.getMaps_p(), 0,
                        m.getMaps_p().length);
            }
       ...
       //
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerViewwwww);
        ...
        productsBDD.close();
        for (Products m : productsList2){

            if(m.getProduct_id().equals(product_id_p)){
mContentItems.add(m);
            }
                                                    ...
                                                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                                                        ...
                                                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                                            ...
                                                            if (withbudget) {
                                                                ...
                                                                shoppingListBDD.close();
                                                                new SnackBar.Builder(QRProductFindActivity.this)
