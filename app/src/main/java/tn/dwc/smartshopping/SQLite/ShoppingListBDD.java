...
public class ShoppingListBDD {

    private static final int VERSION_BDD = 3;
    private static final String NAME_BDD = "shoppinglist2.db";

    private SQLiteDatabase bdd;

    private DBHelper dbHelper;

    public ShoppingListBDD(Context context) {
        super();
    ...
    public long insertTop(ShoppingList dt) {
        ...
        bdd.insert(DBHelper.TABLE_SHOPPING_LIST, null, values);
    ...
    public int UpdateById(String id){
        ...
        bdd.execSQL("UPDATE " + DBHelper.TABLE_SHOPPING_LIST + " SET "+DBHelper.SHOPPING_PRODUCT_STATE+" = 'true' WHERE " + DBHelper.SHOPPING_PRODUCT_ID  +" = '"+id+"'");
        return 0;
    }
    public int UpdateById1(String id){

        bdd.execSQL("UPDATE " + DBHelper.TABLE_SHOPPING_LIST + " SET "+DBHelper.SHOPPING_PRODUCT_STATE+" = 'false' WHERE " + DBHelper.SHOPPING_PRODUCT_ID  +" = '"+id+"'");
        return 0;
    }
    public int removeById(String id){

        bdd.execSQL("DELETE FROM " + DBHelper.TABLE_SHOPPING_LIST + " WHERE " + DBHelper.SHOPPING_PRODUCT_ID  +" = '"+id+"'");
        return 0;
    }
    public int removeAllArticles() { // TODO Remove all Table
        bdd.execSQL("DELETE FROM " + DBHelper.TABLE_SHOPPING_LIST);
        return 0;
    }
    ...
    public List<ShoppingList> selectAll() {
        ...
        Cursor cursor = bdd.query(DBHelper.TABLE_SHOPPING_LIST, new String[] {
